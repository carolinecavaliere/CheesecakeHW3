...
var host = "34.82.148.222";    //from GCloud instance (change to match your db)
var database = "CHEESECAKE";  //database name
var user = "root";         //username (change to match your db)
var password = "Hummingbird2021";  //password (change to match your db, yes this is very poor practice)
